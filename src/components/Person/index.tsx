...
import { IconChevronUp, IconCross, IconExternalLink, IconMovie, IconStar } from "@tabler/icons-react";
    ...
    return (
        <div className="person">
            ...
            <aside className="person__aside">
                ...
                <footer className="person__aside__footer">
                    <Link href={"#"} className="icon aside-icon">
                        <IconChevronUp />
                    </Link>
                </footer>
            </aside>
