...
import { TVSeriesDetailsType, WatchProvidersMod, WatchProvidersType } from "@/types";
...
export const WatchProviders = ({
    ...
    if (!series.watch_providers) return null;
    if (!series.watch_providers.results) return null;
    if (!series.watch_providers.results[locale.split('-')[1]]) return null;

    const watchProviders = series.watch_providers as WatchProvidersType;
    const watchProvidersOptions = series.watch_providers.results[locale.split('-')[1]];
